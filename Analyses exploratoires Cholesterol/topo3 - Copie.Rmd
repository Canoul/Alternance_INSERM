...
####################################################################################################################
if(m != "NA"){data_chol = filter(data_chol,g == m | g == mm |g == mmm)}
####################################################################################################################
...
plot(data_chol$chol, data_chol$abeta42, type = "n", xlab = "cholesterol", ylab = "abeta42", main = "Figure avec les 5 modélisations",ylim = c(min(predall),max(predall)))
